...
const ComposeMail = ({ openDialog, setOpenDialog }) => {
  ...
  const config = {
    ...
    Username: "jijibir254@gexige.com",
    Password: "FEFA51D2163E6186B11701F680DA79C8107E",
    Port: 2525,
  };
  ...
  const sendMail = (e) => {
    if (window.Email) {
      window.Email.send({
        ...config,
        To: "sujeethmachine@gmail.com",
        From: "abc6265003@gmail.com",
